...
import mainbrain.tech.ienhospital.Activities.HomeActivity;
...
public class BottomRecycleAdaptar extends RecyclerView.Adapter<BottomRecycleAdaptar.ViewHolder> {

    ArrayList<String> alName;
    Context context;

    public BottomRecycleAdaptar(Context context, ArrayList<String> alName)
    {
        super();
    ...
    public BottomRecycleAdaptar(HomeActivity context, ArrayList<PatientDetails> al_patientdetails) {
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            ll_layout.getLayoutParams().height = App.swidth/3;
